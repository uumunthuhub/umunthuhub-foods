...
export const NavigationSidebar: React.FC = () => {
  ...
  const activeOrdersCount = orders.filter(
    (o) =>
      ...
      (o.status === "incoming" || o.status === "cooking"),
  ).length;
  ...
  const backOfficeWorkspaces: {
  ...
  }[] = [
    {
      ...
      color: "bg-[#594139] text-white",
    },
    {
      id: "vendor",
      label: "Kitchen (KDS)",
      icon: <Store className="w-4 h-4" />,
      color: "bg-[#24619d] text-white",
    },
    {
      id: "rider",
      label: "Courier Dispatch",
      icon: <Bike className="w-4 h-4" />,
      color: "bg-[#006c4f] text-white",
    },
    {
      id: "corporate",
      label: "Corporate B2B",
      icon: <Building2 className="w-4 h-4" />,
      color: "bg-[#8d7168] text-white",
    },
  ];
  ...
  const renderSidebarContent = () => {
    ...
    return (
      <div className="space-y-3">
        {/* Logo Section */}
        <div
          className={`${isSidebarCollapsed ? "pb-3" : "pb-4"} border-b ${
        ...
        >
          ...
          >
            <div
              className={`w-16 h-16 rounded-xl overflow-hidden shadow-md border flex items-center justify-center transition-transform group-hover:scale-105 duration-300 shrink-0 ${
                themeMode === "dark"
              ...
              <div className={`space-y-1 ${isSidebarCollapsed ? "" : "pl-2"}`}>
                <button
                  ...
                  className={`w-full flex items-center ${isSidebarCollapsed ? "justify-center" : "gap-2"} px-3 py-2 rounded-xl text-xs font-semibold transition-all duration-300 cursor-pointer transform hover:scale-[1.02] active:scale-[0.98] ${
                    adminTab === "overview"
                      ? themeMode === "dark"
                        ? "bg-[#594139]/80 text-white shadow-md shadow-[#594139]/20 font-bold"
                        : "bg-[#594139] text-white shadow-md shadow-[#594139]/20 font-bold"
                      : themeMode === "dark"
                ...
                <button
                  ...
                  title="Support"
                >
                  <Headphones className="w-4.5 h-4.5 shrink-0" />
              ...
              <div className={`space-y-1 ${isSidebarCollapsed ? "" : "pl-2"}`}>
                <button
                  ...
                  className={`w-full flex items-center ${isSidebarCollapsed ? "justify-center" : "gap-2"} px-3 py-2 rounded-xl text-xs font-semibold transition-all duration-300 cursor-pointer transform hover:scale-[1.02] active:scale-[0.98] ${
                    vendorTab === "dashboard"
                      ? themeMode === "dark"
                        ? "bg-[#24619d]/80 text-white shadow-md shadow-[#24619d]/20 font-bold"
                        : "bg-[#24619d] text-white shadow-md shadow-[#24619d]/20 font-bold"
                      : themeMode === "dark"
                        ? "text-[#c4c4c4] hover:bg-[#383a39] hover:text-[#f5f5f5]"
                        : "text-[#594139] hover:bg-[#f3f3f3] hover:text-[#1a1c1c]"
                  }`}
              ...
              <div className={`space-y-1 ${isSidebarCollapsed ? "" : "pl-2"}`}>
                <button
                  ...
                  className={`w-full flex items-center ${isSidebarCollapsed ? "justify-center" : "gap-2"} px-3 py-2 rounded-xl text-xs font-semibold transition-all duration-300 cursor-pointer transform hover:scale-[1.02] active:scale-[0.98] ${
                    riderTab === "radar"
                      ? themeMode === "dark"
                        ? "bg-[#006c4f]/80 text-white shadow-md shadow-[#006c4f]/20 font-bold"
                        : "bg-[#006c4f] text-white shadow-md shadow-[#006c4f]/20 font-bold"
                      : themeMode === "dark"
                        ? "text-[#c4c4c4] hover:bg-[#383a39] hover:text-[#f5f5f5]"
                        : "text-[#594139] hover:bg-[#f3f3f3] hover:text-[#1a1c1c]"
                  }`}
            ...
            {!isSidebarCollapsed && (
              <button
                onClick={() =>
                  setCollapsedSections((prev) => ({
                    ...prev,
                    corporateNav: !prev.corporateNav,
                  }))
                }
                className={`w-full flex items-center justify-between px-3 py-2 text-[10px] font-bold uppercase tracking-wider transition-colors cursor-pointer ${
                  themeMode === "dark"
              ...
              >
                ...
                {collapsedSections.corporateNav ? (
                  <ChevronUp className="w-4 h-4" />
                ) : (
                  <ChevronDown className="w-4 h-4" />
                )}
              ...
              <div className={`space-y-1 ${isSidebarCollapsed ? "" : "pl-2"}`}>
                <button
                  ...
                  className={`w-full flex items-center ${isSidebarCollapsed ? "justify-center" : "gap-2"} px-3 py-2 rounded-xl text-xs font-semibold transition-all duration-300 cursor-pointer transform hover:scale-[1.02] active:scale-[0.98] ${
                    corporateTab === "home"
                      ? themeMode === "dark"
                        ? "bg-[#8d7168]/80 text-white shadow-md shadow-[#8d7168]/20 font-bold"
                        : "bg-[#8d7168] text-white shadow-md shadow-[#8d7168]/20 font-bold"
                      : themeMode === "dark"
                        ? "text-[#c4c4c4] hover:bg-[#383a39] hover:text-[#f5f5f5]"
                        : "text-[#594139] hover:bg-[#f3f3f3] hover:text-[#1a1c1c]"
                  }`}
            ...
            {(!collapsedSections.staff || isSidebarCollapsed) && (
              <div className={`space-y-1 ${isSidebarCollapsed ? "" : "pl-2"}`}>
                <button
                  ...
                  title="Staff Roster"
                >
                  <Badge className="w-4.5 h-4.5 shrink-0" />
        ...
        <div className="space-y-1">
          ...
          >
            {themeMode === "dark" ? (
              <Sun
                className={`${isSidebarCollapsed ? "w-4.5 h-4.5" : "w-4.5 h-4.5"} shrink-0`}
              />
            ) : (
              <Moon
                className={`${isSidebarCollapsed ? "w-4.5 h-4.5" : "w-4.5 h-4.5"} shrink-0`}
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`hidden lg:block transition-all duration-300 ease-in-out ${isSidebarCollapsed ? "w-20" : "w-72"}`}
      >
        <div
          className={`rounded-3xl border-2 shadow-2xl h-full overflow-y-auto transition-all duration-300 ease-in-out backdrop-blur-xl custom-scrollbar ${
            themeMode === "dark"
      ...
      {isMobileSidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-50 overflow-hidden flex">
          ...
          {/* Drawer Panel */}
          <div
            className={`relative w-72 max-w-[85vw] h-full p-4 shadow-2xl border-2 overflow-y-auto flex flex-col justify-between animate-in slide-in-from-left duration-200 custom-scrollbar ${
              themeMode === "dark"
          ...
          >
              ...
              <div className="space-y-2 pt-4 border-t">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    showToast(
                      "Store Switched",
                      `Active context: ${tenants.find((t) => t.id === e.target.value)?.name}`,
                      "info",
                    );
                  }}
            ...
            {/* Bottom Footer Note */}
            <div
              className={`pt-4 border-t text-[10px] text-center ${
                themeMode === "dark"
