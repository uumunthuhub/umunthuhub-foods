    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#006c4f]/10 flex items-center justify-center">
              <Monitor className="w-5 h-5 text-[#006c4f]" />
            </div>
            <div>
              <h3
        ...
        <div className="p-5 space-y-4">
          {sessions.length === 0 ? (
            <div className="text-center py-8">
              <CheckCircle className="w-12 h-12 text-[#7a7a7a]" />
              <p
                className={`mt-3 text-sm font-medium ${themeMode === "dark" ? "text-[#c4c4c4]" : "text-gray-700"}`}
              >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <p
                          className={`font-bold text-xs ${themeMode === "dark" ? "text-[#f5f5f5]" : "text-gray-900"}`}
                        >
                          {session.device}
                        </p>
                        {session.current && (
        ...
        {sessions.some((s) => !s.current) && (
          <div
            className={`p-5 border-t ${themeMode === "dark" ? "bg-[#383a39]/50 border-[#3a3a3a]" : "bg-gray-50 border-gray-200"}`}
          >
            <button
        ...
        <div
          className={`flex gap-3 p-5 border-t sticky bottom-0 ${
            themeMode === "dark"
              ? "bg-[#242625] border-[#3a3a3a]"
              : "bg-white border-gray-200"
          }`}
