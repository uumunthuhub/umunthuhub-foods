...
export const CustomerHome: React.FC = () => {
  ...
  const [activeFilter, setActiveFilter] = useState<
    "all" | "rating" | "speed" | "free_delivery"
  >("all");
  ...
  const heroVideos = [
    {
      video:
        "https://res.cloudinary.com/irouybuw/video/upload/v1788421604/Assembling_wagyu_burger_with_cheese_202608191233.mp4",
    ...
    {
      video:
        "https://res.cloudinary.com/irouybuw/video/upload/v1788421603/Chef_slicing_salmon_sushi_roll_202608192132.mp4",
    ...
    {
      video:
        "https://res.cloudinary.com/irouybuw/video/upload/v1788421584/Chopsticks_lifting_noodle_from_r__202608192141.mp4",
    ...
    {
      video:
        "https://res.cloudinary.com/irouybuw/video/upload/v1788421592/Sauce_drizzling_over_fried_chicken_202608191449.mp4",
  ...
  let filteredTenants = tenants.filter((t) => {
    ...
    const matchesCat =
      ...
      t.cuisine.toLowerCase().includes(selectedCategory.toLowerCase());
  ...
  if (activeFilter === "rating") {
    ...
    filteredTenants = [...filteredTenants].sort(
      (a, b) => a.prepTimeAvg - b.prepTimeAvg,
    );
  ...
  return (
    ...
    >
      ...
      <section
        className={`relative overflow-hidden rounded-4xl p-6 sm:p-10 w-[calc(100%-1.5rem)] sm:w-[calc(100%-2.5rem)] max-w-7xl mx-auto backdrop-blur-2xl border shadow-[0_8px_40px_-8px_rgba(171,53,0,0.18)] ${
          themeMode === "warm"
            ? "bg-[#fffbf7]/60 border-[#d4c4b8]/50"
            : themeMode === "dark"
              ? "bg-[#242625]/60 border-white/10"
              : "bg-white/35 border-white/60"
        }`}
      >
        {/* Ambient light — softer, more diffuse than a flat blur blob */}
        <div
          className={`absolute -top-32 -right-32 w-md h-112 rounded-full blur-[80px] -z-10 pointer-events-none ${
            themeMode === "warm"
              ? "bg-linear-to-br from-[#ff6b35]/20 via-[#ffb088]/10 to-transparent"
              : themeMode === "dark"
                ? "bg-linear-to-br from-[#ff6b35]/15 via-[#ab3500]/10 to-transparent"
                : "bg-linear-to-br from-[#ff6b35]/25 via-[#ffb088]/10 to-transparent"
          }`}
        />
        <div
          className={`absolute -bottom-32 -left-24 w-96 h-96 rounded-full blur-[80px] -z-10 pointer-events-none ${
            themeMode === "warm"
              ? "bg-linear-to-tr from-[#5c4a3d]/10 via-[#d4c4b8]/8 to-transparent"
              : themeMode === "dark"
                ? "bg-linear-to-tr from-[#87bcfe]/10 via-[#24619d]/8 to-transparent"
                : "bg-linear-to-tr from-[#24619d]/12 via-[#87bcfe]/10 to-transparent"
          }`}
        />
        {/* Faint inner sheen for glass depth */}
        <div
          className={`absolute inset-0 rounded-4xl -z-10 pointer-events-none ${
            themeMode === "warm"
              ? "bg-linear-to-b from-[#fffbf7]/30 via-transparent to-transparent"
              : themeMode === "dark"
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-5">
            <div
              className={`inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full backdrop-blur-md border shadow-sm text-[#ab3500] text-xs font-bold ${
                themeMode === "warm"
                  ? "bg-[#fffbf7]/70 border-[#d4c4b8]/60"
                  : themeMode === "dark"
                    ? "bg-[#242625]/70 border-white/20"
            ...
            >
              ...
              <span
                ...
                className={`text-[10px] font-semibold underline underline-offset-2 hover:text-[#ab3500] cursor-pointer transition-colors ${
                  themeMode === "warm"
                    ? "text-[#6b5a4a] decoration-[#d4c4b8]"
                    : themeMode === "dark"
                      ? "text-[#c4c4c4] decoration-white/30"
            ...
            <h1
              className={`font-heading font-extrabold text-3xl sm:text-4xl lg:text-[3.25rem] tracking-tight leading-[1.05] ${
                themeMode === "warm"
                  ? "text-[#3d2b1f]"
                  : themeMode === "dark"
                    ? "text-[#f5f5f5]"
            ...
            >
              Savor organic farm bowls, triple-smashed wagyu burgers, artisan
              woodfired pizzas, and Tokyo-grade sushi from verified kitchens.
            </p>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3">
              <button
                onClick={() => {
                  ...
                  showToast(
                    "Top Rated Kitchens",
                    "Showing verified kitchens rated 4.8★ and above",
                    "info",
                  );
              ...
              >
                <span className="material-symbols-outlined text-[17px] fill-1">
                  stars
                </span>
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-2xl backdrop-blur-md hover:backdrop-blur-lg border text-[#ab3500] text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer shadow-sm ${
                  themeMode === "warm"
                    ? "bg-[#fffbf7]/60 hover:bg-[#fffbf7]/80 border-[#d4c4b8]/60"
                    : themeMode === "dark"
                      ? "bg-[#242625]/60 hover:bg-[#242625]/80 border-white/20"
              ...
              <div
                className={`hidden lg:flex items-center gap-2 pl-3 ml-1 border-l text-xs font-bold ${
                  themeMode === "warm"
                    ? "border-[#d4c4b8]/50 text-[#6b5a4a]"
                    : themeMode === "dark"
                      ? "border-white/20 text-[#c4c4c4]"
          ...
          <div className="hidden lg:block">
            <div className="relative overflow-hidden">
              <div
                className={`absolute top-2 right-2 px-3 py-1.5 rounded-full backdrop-blur-md border shadow-md text-[#ab3500] text-[10px] font-extrabold tracking-wide flex items-center gap-1 z-10 ${
                  themeMode === "warm"
                    ? "bg-[#fffbf7]/80 border-[#d4c4b8]/70"
                    : themeMode === "dark"
                      ? "bg-[#242625]/80 border-white/20"
              ...
              <div className="space-y-2">
                <div className="flex items-start justify-between">
                  ...
                  <div
                    className={`flex items-center gap-1 text-[10px] font-bold text-amber-600 px-1.5 py-0.5 rounded-md ${
                      themeMode === "warm"
                        ? "bg-[#fffbf7]/70"
                        : themeMode === "dark"
                          ? "bg-[#242625]/70"
                ...
                <div className="flex items-center justify-between pt-1">
                  <div
                    className={`px-3 py-1.5 rounded-lg border-2 border-[#ab3500] shadow-sm ${
                      themeMode === "warm"
                        ? "bg-[#fffbf7]"
                        : themeMode === "dark"
                          ? "bg-[#242625]"
                      ...
                      const matchingDish = menuItems.find(
                        (m) =>
                          m.name
                            .toLowerCase()
                            .includes(
                              currentHeroItem.name.toLowerCase().split(" ")[0],
                            ) ||
                          currentHeroItem.name
                            .toLowerCase()
      ...
      <div className="flex items-center gap-2">
        <span
          className={`text-xs font-bold mr-1 shrink-0 flex items-center gap-1 ${
            themeMode === "warm"
              ? "text-[#6b5a4a]"
              : themeMode === "dark"
                ? "text-[#c4c4c4]"
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-xl text-xs font-semibold transition-colors cursor-pointer ${
                activeFilter === filter.id
                  ...
                  : themeMode === "warm"
                    ? "bg-[#fffbf7] text-[#6b5a4a] border border-[#d4c4b8]/50 hover:bg-[#f5ede4]"
                    : themeMode === "dark"
                      ? "bg-[#242625] text-[#c4c4c4] border border-white/20 hover:bg-[#2e302f]"
      ...
      <section ref={restaurantsSectionRef} className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            >
              Partner restaurants ready for immediate dispatch
            </p>
          </div>
            ...
            >
              <div>
                ...
                <div className="relative h-48 w-full overflow-hidden">
                  ...
                  <div className="absolute top-3 left-3">
                    <span
                      className={`px-2.5 py-1 rounded-xl backdrop-blur-md text-[#006c4f] text-[10px] font-bold flex items-center gap-1 shadow-md ${
                        themeMode === "dark" ? "bg-[#242625]/90" : "bg-white/90"
                      }`}
                    >
                      <span className="material-symbols-outlined text-[14px] text-[#00ae81]">
                        verified
                      </span>
                      Verified
                    </span>
                  ...
                  {/* Rating Pill */}
                  <div
                    className={`absolute top-3 right-3 px-2.5 py-1 rounded-xl backdrop-blur-md flex items-center gap-1 shadow-md ${
                      themeMode === "warm"
                        ? "bg-[#fffbf7]/90"
                        : themeMode === "dark"
                          ? "bg-[#242625]/90"
                  ...
                  <div className="absolute bottom-3 left-3 px-2.5 py-1 rounded-xl bg-black/60 backdrop-blur-md text-white text-xs font-bold flex items-center gap-1">
                    <span className="material-symbols-outlined text-[15px] text-[#54fdc4]">
                      schedule
                    </span>
                  ...
                  {/* Delivery Fee pill */}
                  <div
                    className={`absolute bottom-3 right-3 px-2.5 py-1 rounded-xl backdrop-blur-md text-xs font-bold ${
                      themeMode === "warm"
                        ? "bg-[#fffbf7]/90 text-[#3d2b1f]"
                        : themeMode === "dark"
                          ? "bg-[#242625]/90 text-[#f5f5f5]"
                    ...
                    <div className="flex-1 min-w-0">
                      <h3
                        className={`font-heading font-bold text-base transition-colors truncate ${
                          themeMode === "warm"
                            ? "text-[#3d2b1f] group-hover:text-[#ab3500]"
                            : themeMode === "dark"
                              ? "text-[#ffffff] group-hover:text-[#ab3500]"
                    ...
                    {tenant.tags.map((tag) => (
                      <span
                        ...
                        className={`px-2.5 py-0.5 rounded-lg text-[10px] font-semibold border ${
                          themeMode === "warm"
                            ? "bg-[#f5ede4] text-[#6b5a4a] border-[#d4c4b8]/40"
                            : themeMode === "dark"
                              ? "bg-[#2e302f] text-[#c4c4c4] border-white/20"
              ...
              >
                <span className="flex flex-row leading-tight items-center gap-2">
                  ...
                  <span className="text-base font-bold text-[#ab3500]">
                    ${tenant.minOrder.toFixed(2)}
                  </span>
                </span>
          ...
          {[
            ...
            <button
              ...
              className={`px-3 py-2 rounded-xl text-xs font-semibold transition-colors cursor-pointer border ${
                themeMode === "warm"
                  ? "bg-[#f5ede4] hover:bg-[#e9ddcf] text-[#6b5a4a] border-[#d4c4b8]/40"
                  : themeMode === "dark"
                    ? "bg-[#2e302f] hover:bg-[#383a39] text-[#c4c4c4] border-white/20"
      ...
      <section className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            >
              Signature dishes ordered most frequently
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-white text-[#ab3500]">
                NEW
              </span>
            </div>
      ...
      {isAddressModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
          <div
            className={`rounded-3xl p-6 border shadow-2xl max-w-md w-full animate-in fade-in zoom-in-95 duration-200 ${
              themeMode === "dark"
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                <span
                  className={`p-2 rounded-xl text-[#ab3500] ${
                ...
                <button
                  onClick={() => {
                    if (tempAddress.trim()) {
                      ...
                      showToast(
                        "Address Updated",
                        `Delivery address changed to ${tempAddress.trim()}`,
                        "success",
                      );
                    }
                  }}
