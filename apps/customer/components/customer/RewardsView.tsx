    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-white hover:bg-[#f3f3f3] border border-[#e1bfb5]/60 text-xs font-bold text-[#594139] shadow-sm transition-colors self-start sm:self-auto cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-6 glass-panel rounded-3xl p-6 border border-[#e1bfb5]/50 flex flex-col justify-between space-y-4">
          <div>
            <div className="flex items-center justify-between mb-2">
              <div>
                <span className="text-xs font-bold text-[#8d7168] uppercase tracking-wider">Tier Progression</span>
                <h3 className="font-heading font-extrabold text-base text-[#1a1c1c]">Road to Platinum Tier</h3>
              </div>
            ...
            {/* Progress bar */}
            <div className="w-full h-3 bg-[#eeeeee] rounded-full overflow-hidden my-3">
              <div
                style={{ width: `${currentProgressPercent}%` }}
                className="h-full bg-gradient-to-r from-[#ff6b35] to-[#ab3500] rounded-full transition-all duration-700 shadow-sm"
              />
            </div>
          ...
          {/* Tier Perks Grid */}
          <div className="grid grid-cols-2 gap-2 pt-2 border-t border-[#e1bfb5]/40 text-xs">
            <div className="flex items-center gap-2 p-2 bg-[#f9f9f9] rounded-xl border border-[#e1bfb5]/40">
              <span className="material-symbols-outlined text-[#00ae81] text-[18px]">check_circle</span>
              <span className="text-[#1a1c1c] font-semibold">Priority Driver Dispatch</span>
            </div>
            <div className="flex items-center gap-2 p-2 bg-[#f9f9f9] rounded-xl border border-[#e1bfb5]/40">
              <span className="material-symbols-outlined text-[#00ae81] text-[18px]">check_circle</span>
              <span className="text-[#1a1c1c] font-semibold">Free Seasonal Desserts</span>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-4">
        <div>
          ...
          <p className="text-xs text-[#594139]">Instantly convert your loyalty points into usable checkout discounts</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {loyaltyRewards.map(reward => {
            ...
            return (
              <div
                key={reward.id}
                className="glass-panel rounded-3xl p-5 border border-[#e1bfb5]/50 flex flex-col justify-between space-y-4 hover:shadow-lg transition-all"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="px-2.5 py-1 rounded-xl bg-[#f3f3f3] text-[#ab3500] text-xs font-extrabold border border-[#e1bfb5]/50">
                      {reward.pointsCost} pts
                    </span>
                  </div>

                  <div>
                    <h4 className="font-heading font-bold text-sm text-[#1a1c1c]">
                      {reward.title}
                    </h4>
                ...
                <div className="pt-3 border-t border-[#e1bfb5]/40">
                  <button
                    onClick={() => {
      ...
      {/* Culinary Challenges */}
      <section className="glass-panel rounded-3xl p-6 border border-[#e1bfb5]/50 space-y-4">
        <div>
          <h3 className="font-heading font-extrabold text-base text-[#1a1c1c] flex items-center gap-2">
            <span className="material-symbols-outlined text-[#006c4f] text-[22px]">trophy</span>
            Weekly Culinary Challenges
          </h3>
          <p className="text-xs text-[#594139]">Complete interactive missions to boost your point multipliers</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-4 bg-[#f9f9f9] rounded-2xl border border-[#e1bfb5]/40 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-heading font-bold text-xs text-[#1a1c1c]">Organic Healthy Bowl Streak</span>
              <span className="text-[10px] font-extrabold px-2 py-0.5 rounded bg-[#00ae81]/15 text-[#006c4f]">
                +250 PTS
              </span>
            </div>
            <p className="text-[11px] text-[#594139]">Order 3 farm-to-table bowls from The Green Bistro this week</p>
            <div className="w-full h-2 bg-[#eeeeee] rounded-full overflow-hidden">
              <div className="w-2/3 h-full bg-[#00ae81] rounded-full" />
            </div>
            <span className="text-[10px] text-[#8d7168] font-bold">2 of 3 Completed (66%)</span>
          </div>

          <div className="p-4 bg-[#f9f9f9] rounded-2xl border border-[#e1bfb5]/40 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-heading font-bold text-xs text-[#1a1c1c]">Multi-Tenant Flavor Explorer</span>
              <span className="text-[10px] font-extrabold px-2 py-0.5 rounded bg-[#24619d]/15 text-[#24619d]">
                +400 PTS
              </span>
            </div>
            <p className="text-[11px] text-[#594139]">Try food from 3 different partner kitchens this month</p>
            <div className="w-full h-2 bg-[#eeeeee] rounded-full overflow-hidden">
