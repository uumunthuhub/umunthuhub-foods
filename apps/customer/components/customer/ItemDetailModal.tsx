...
export const ItemDetailModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div
        className={`relative w-full max-w-lg glass-panel rounded-3xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200 ${
          themeMode === "warm"
            ? "bg-[#fffbf7]/95 border-[#d4c4b8]"
            : themeMode === "dark"
              ? "bg-[#242625]/95 border-white/20"
      ...
      >
        ...
        <div className="relative h-64 w-full overflow-hidden bg-black/5">
          ...
          <button
            ...
            className={`absolute top-4 right-4 z-20 w-9 h-9 rounded-full flex items-center justify-center shadow-md transition-transform active:scale-95 cursor-pointer ${
              themeMode === "warm"
                ? "bg-[#fffbf7]/80 hover:bg-[#fffbf7] text-[#3d2b1f]"
                : themeMode === "dark"
                  ? "bg-[#242625]/80 hover:bg-[#242625] text-[#f5f5f5]"
        ...
        <div className="p-6 space-y-6 max-h-[55vh] overflow-y-auto">
                      ...
                      className={`text-[10px] font-semibold px-2 py-0.5 rounded-md ${
                        option.required
                          ? themeMode === "warm"
                            ...
                            : themeMode === "dark"
                              ? "bg-[#ffdad6]/50 text-[#ff6b6b]"
                              : "bg-[#ffdad6] text-[#ba1a1a]"
                          : themeMode === "warm"
                            ? "bg-[#f5ede4] text-[#6b5a4a]"
                            : themeMode === "dark"
                              ? "bg-[#2e302f] text-[#c4c4c4]"
                        ...
                        <button
                          ...
                          className={`flex items-center justify-between p-3 rounded-2xl text-xs font-semibold text-left transition-all cursor-pointer ${
                            isSelected
                              ...
                              : themeMode === "warm"
                                ? "bg-[#fffbf7] border-[#d4c4b8]/50 text-[#3d2b1f] hover:bg-[#f5ede4]"
                                : themeMode === "dark"
                                  ? "bg-[#242625] border-white/20 text-[#f5f5f5] hover:bg-[#2e302f]"
                          ...
                          <div className="flex items-center gap-2.5">
                            <div
                              className={`w-4 h-4 rounded-full border flex items-center justify-center ${
                                isSelected
                                  ? "border-[#ab3500] bg-[#ab3500]"
                                  : themeMode === "warm"
                                    ? "border-[#6b5a4a] bg-[#fffbf7]"
                                    : themeMode === "dark"
                                      ? "border-[#c4c4c4] bg-[#242625]"
          ...
          <div className="space-y-1.5">
            <label
              className={`font-heading font-bold text-xs flex items-center gap-1.5 ${
                themeMode === "warm"
                  ? "text-[#3d2b1f]"
                  : themeMode === "dark"
                    ? "text-[#f5f5f5]"
        ...
        <div
          className={`p-5 border-t flex items-center justify-between gap-4 ${
            themeMode === "warm"
              ? "border-t-[#d4c4b8]/40 bg-[#fffbf7]"
              : themeMode === "dark"
                ? "border-t-white/20 bg-[#242625]"
                : "border-t-[#e1bfb5]/40 bg-[#f9f9f9]"
          }`}
        >
          {/* Quantity Controls */}
          <div
            className={`flex items-center gap-3 px-3 py-2 rounded-2xl border shadow-sm ${
              themeMode === "warm"
                ? "bg-white border-[#d4c4b8]/60"
                : themeMode === "dark"
                  ? "bg-[#2e302f] border-white/20"
          ...
          >
            <button
              ...
              className={`w-7 h-7 rounded-xl disabled:opacity-40 flex items-center justify-center font-bold transition-colors ${
                themeMode === "warm"
                  ? "bg-[#f5ede4] hover:bg-[#e9ddcf] text-[#3d2b1f]"
                  : themeMode === "dark"
                    ? "bg-[#2e302f] hover:bg-[#383a39] text-[#f5f5f5]"
            ...
            <span
              className={`font-heading font-extrabold text-sm min-w-4.5 text-center ${
                themeMode === "warm"
                  ? "text-[#3d2b1f]"
                  : themeMode === "dark"
                    ? "text-[#f5f5f5]"
